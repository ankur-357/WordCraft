...
export default function ToolBox({ text, setText }) {
  ...
  function generateRandomText() {
    // Generate a random string or use an API to fetch random text
    const randomText = `
    My name is Ankur Kumar

    I am a web developer from India. I am a full stack developer.
    I studied high school from DAV public School, Gopalganj.
    I did my secondary schooling from Gayanda Internation School, Gopalganj
    I am pursuing computer science engineering from National Institute of technology Srinagar.`;
    setText(randomText);
  }
  ...
  return (
    <>
      <div className="flex fixed flex-col md:flex-row -ml-4 px-2 flex-wrap bottom-0 h-16 w-full max-w-full overflow-x-auto justify-start md:justify-center items-center bg-white overflow-y-auto select-none">
        {/* Magic Spell */}
        <div
        ...
        {/* Clear Text */}
        <div className="inline-flex flex-col justify-center items-center ml-2 w-28 cursor-pointer" onClick={clearText}>
        ...
        {/* Remove Extra Spaces */}
        <div className="inline-flex flex-col justify-center items-center ml-4 w-28 cursor-pointer" onClick={removeExtraSpaces}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 12H6"></path>
          </svg>
          <span className="whitespace-nowrap">Remove Spaces</span>
        </div>
        ...
        <div className="inline-flex flex-col justify-center items-center ml-2 w-28 cursor-pointer" onClick={generateRandomText}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5zM12 14V3"></path>
          </svg>
          About Me
        </div>
        {/* Contribute */}
        ...
        {/* Useful AI Prompts */}
        <a
          className="inline-flex flex-col justify-center items-center ml-4 w-24 cursor-pointer"
          href="AiPrompt.html"
          target="_blank"
          rel="noreferrer"
        >
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth="2"
              d="M16 21.632l1.263-1.263M8 6.368L6.737 7.632M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
            />
          </svg>
          <span className="whitespace-nowrap">Useful AI Prompts</span>
        </a>
